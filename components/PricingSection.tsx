...
function PricingSection() {
    ...
    const basicPricingKey=process.env.NEXT_PUBLIC_BASIC_PRICE_ID;
    const standardPricingKey=process.env.NEXT_PUBLIC_STANDARD_PRICE_ID;
    const premiumPricingKey=process.env.NEXT_PUBLIC_PREMIUM_PRICE_ID;
    ...
    return (
        <div className="xl:container m-auto px-6 py-20 md:px-12 lg:px-20">
            ...
            <div className="mt-12 grid items-center gap-6 md:grid-cols-2 lg:flex lg:space-x-8">
                {priceData.map(data=><Price key={data.id} data={data}/>)
                }
                ...
                {/* <div className="group relative row-start-1 md:col-span-2 lg:w-[36%]">
                    ...
                    <div className="relative space-y-8 p-8">
                        ...
                        <button onClick={()=>setPriceInfo({price:"150",prideId:standardPricingKey})} className="relative flex h-11 w-full items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-gradient-to-r from-yellow-300 to-pink-300 before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95">
                ...
                {/* <div className="group relative md:col-span-1 lg:w-[32%]">
                    ...
                    <div className="relative space-y-8 p-8">
                        ...
                        <button onClick={()=>setPriceInfo({price:"200",prideId:premiumPricingKey})} className="relative flex h-11 w-full items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-sky-50 before:border before:border-sky-500  before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95">
