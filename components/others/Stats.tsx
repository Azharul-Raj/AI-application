      ...
      <div className="space-y-6 justify-between text-gray-600 md:flex flex-row-reverse md:gap-6 md:space-y-0 lg:gap-12 lg:items-center">
        ...
        <div className="md:7/12 lg:w-1/2">
          ...
          <p className="my-8 text-gray-600 dark:text-gray-300">
            ...
            Asperiores nemo possimus nesciunt dicta veniam aspernatur quam mollitia. <br/> Vitae error, quaerat officia delectus voluptatibus explicabo quo pariatur impedit, at reprehenderit aliquam a ipsum quas voluptatem. Quo pariatur asperiores eum amet.
          </p>
